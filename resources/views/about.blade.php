                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5 col-lg-5 col-xl-7">
                        <div class="page-header-thumb">
                            <img src="assets/images/FPK202206214-removebg-preview.png" width="570" height="669"
                ...
                <div class="row mb-n6">
                    <div class="col-sm-6 col-lg-4 mb-6">
                        ...
                        <div class="funfact-item">
                            <div class="icon">
                                <img src="assets/images/icons/funfact1.webp" width="110" height="110"
                                    alt="Diarika Beauty Official Website">
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-6">
                        ...
                        <div class="funfact-item">
                            <div class="icon">
                                <img src="assets/images/icons/funfact2.webp" width="110" height="110"
                                    alt="Diarika Beauty Official Website">
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-6">
                        ...
                        <div class="funfact-item">
                            <div class="icon">
                                <img src="assets/images/icons/funfact3.webp" width="110" height="110"
                                    alt="Diarika Beauty Official Website">
                            </div>
...
@section('css')
    ...
    <title>About - Diarika Beauty</title>
    <meta property="og:title" content="Diarika Beauty" />
    <meta name="description"
        content="Diarika Beauty didirikan oleh Ibu Rika Nursanti S.E, pada tanggal 18 Desember 2018 di
    Jalan Raya Tanjungmulya No.384 Panumbangan Ciamis Jawa Barat.
    Bearawal dari tahun 2016 dimana owner memiliki beberapa permasalahan kulit yang tak
    kunjung sembuh"
        itemprop="description" />
    <meta name="originalTitle" content="Diarika Beauty - About" />
