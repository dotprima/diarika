                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content">
                            ...
                            <div class="product-details-review">
                                ...
                                <button type="button" class="product-review-show">{{ $productInfo->review }}
                                    reviews</button>
                            </div>
                            ...
                            <div class="product-details-action">
                                ...
                                <div class="product-details-cart-wishlist">
                                    ...
                                    <a href="/whatsapp?id={{ $productInfo->id }}" target="_blank" rel="nofollow"
                                        class="btn">
                                    ...
                                    <div class="swiper-slide mb-10">
                                        ...
                                        <div class="product-item product-st2-item">
                                            <div class="product-thumb">
                                                <a class="d-block"
                                                    href="{{ env('APP_URL') }}/catalog/{{ $products->url }}">
                                                    <img src="{{ env('APP_URL') }}/product/{{ $products->image }}"
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-action">
                                                    <a href="/whatsapp?id={{ $products->id }}" target="_blank"
                                                        rel="nofollow" class="product-action-btn action-btn-cart">
                                                        <span>Beli Sekarang</span>
                                                    </a>
                                                    <button type="button"
                                                        class="product-action-btn action-btn-quick-view"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#action-QuickViewModal{{ $products->id }}">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="product-single-thumb">
                                                <img src="{{ env('APP_URL') }}/product/{{ $products->image }}"
                                                    width="544" height="560" alt="Diarika Beauty Official Website">
                                            </div>
...
@section('css')
    ...
    <meta name="description" content="{{ $productInfo->deskripsi }}" itemprop="description" />
    <meta name="originalTitle" content="Diarika Beauty - Produk {{ $productInfo->judul }}" />
    <meta property="og:description" content="{{ $productInfo->deskripsi }}" />
    <meta content="{{ $productInfo->deskripsi }}" />
    <meta name="twitter:description"
        content="{{ $productInfo->deskripsi }}" />
